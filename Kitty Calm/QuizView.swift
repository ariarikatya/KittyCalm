    ...
    private static func makeQuestions() -> [QuizQuestion] {
        let all: [QuizQuestion] = [
            ...
            QuizQuestion(
                ...
                correctIndex: 1,
                fact: "Letting a cat choose to approach you, and sniff your hand first, helps them feel in control and safer."
            ),
            QuizQuestion(
                question: "Why do cats like high places such as shelves?",
                options: [
                    "They think they can fly",
                    "To watch the room safely from above",
                    "Because the floor is too noisy",
                    "To hide from their whiskers"
                ],
                correctIndex: 1,
                fact: "High spots let cats observe everything while feeling secure, which is very calming for them."
            ),
            QuizQuestion(
                question: "What do a cat’s whiskers help them with?",
                options: [
                    "Smelling biscuits",
                    "Measuring gaps and sensing space",
                    "Remembering birthdays",
                    "Learning new tricks"
                ],
                correctIndex: 1,
                fact: "Whiskers are very sensitive and help cats judge spaces and movement around them."
            )
        ]
